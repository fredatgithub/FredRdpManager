...
- Si l’application est installée dans un répertoire protégé (par ex. **Program Files**), l’écriture de `connections.xml` peut nécessiter des droits administrateur ou un autre emplacement de déploiement.
